...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        using (IRepository repository = new Repository("D:\\6sem\\TDWA\\2\\ASPA\\Test_DAL004\\Celebrities"))
        {
            ...
            app.MapDelete("/{id:int}", (int id, HttpContext context) =>
            {
            ...
            .AddEndpointFilter<Validation.CheckCelebrityExistsFilter>();

            app.MapPut("/{id:int}", (int id, Celebrity celebrity, HttpContext context) =>
            {
            ...
            app.Map("/Celebrities/Error", (HttpContext ctx) =>
            {
                ...
                if (ex != null)
                {
                    ...
                    if (ex is NullFieldExeption) rc = Results.Problem(title: "ASPA005/UpdCelebrity", detail: ex.Message, instance: app.Environment.EnvironmentName, statusCode: 409);
                }
...
public class NullFieldExeption : Exception { public NullFieldExeption(string message) : base($"NullFieldExeption error: {message}") { } };
